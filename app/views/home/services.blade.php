						...
						<div class="col-xs-12 col-sm-7 col-md-9 block-right">
							...
							<div class="tab-content">
								<div role="tabpanel" class="tab-pane fade in active" id="сommunication-with-customers">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6">
                                            <p>Другими словами, это любой контакт или взаимодействие с клиентом. Это контакт между организацией/компанией и внешней средой.
                                                Фирменный стиль компании, популярность названия компании, ясность позиционирования, внешний вид и современность сайта. Количество и актуальность информации о вашей компании в интернете, количество и качество отзывов, и, конечно, ответы на них. Осведомленность персонала о продуктах компании, вежливое отношение и грамотное общение персонала с клиентом. Все это является внешними коммуникациями с потребителем. (либо: Все это является результатом внешних коммуникаций компании). Некоторые компании пренебрегают или не уделяют должного внимания этому этапу в развитии компании. Это чревато/грозит потерей клиента в долгосрочной перспективе или отторжением потенциальным потребителем продуктов компании.</p>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="communication-with-public">
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6">
                                            <p>Данные коммуникации происходят вне зависимости от размеров и известности компании, как может изначально показаться. В нашем мире/Сейчас компании, которые не стремятся к популярности, так или иначе коммуницируют/взаимодействуют с общественностью. Для этого достаточно просто разместить информацию о компании или ее продукции в интернете. Сайт компании, информация в справочниках и социальных сетях, статьи в газетах и журналах, интервью на радио или выступление на телепередачах, официальные заявления и открытые презентации товара, проводимые компанией, всё это коммуникации с общественностью. Сложившееся общественное мнение влияет на репутацию, статус и привлекательность компании для потребителя или партнера. Все эти факторы сказываются на результате принятого решения о приобретении товара у этой компании или дальнейшего сотрудничества. Правильные способы/методы (или: правильно построенные каналы коммуникации) коммуникации с общественностью обеспечат лояльную аудиторию и долгосрочный рост клиентов.</p>
                                            <h3>Задачи в рамках раздела:</h3>
                                            <ul>
                                                <li>Анализировать задачи компании</li>
